...
#if TIMER
                        auto startOrderingHashProbe = std::chrono::high_resolution_clock::now();
#endif
                        hashes.Reset();
...
#if TIMER
                        auto endOrderingHashProbe = std::chrono::high_resolution_clock::now();
                        orderinghashProbe += endOrderingHashProbe - startOrderingHashProbe;
#endif
                        try {
